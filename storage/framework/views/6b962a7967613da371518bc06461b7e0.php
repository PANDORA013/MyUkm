                                ...
                                <div class="card h-100 border-primary">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="avatar bg-warning text-white d-flex align-items-center justify-content-center me-2" style="width: 38px; height: 38px; border-radius: 50%; font-size: 1.2rem;">
                                                <i class="fas fa-crown"></i>
                                            </div>
                                            <div>
                                                <span class="fw-bold"><?php echo e($group->name); ?></span>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="badge bg-warning text-white"><i class="fas fa-crown me-1"></i>Admin UKM</span>
                            ...
                            <?php $__currentLoopData = $joinedGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center mb-2">
                                                <div class="avatar bg-info text-white d-flex align-items-center justify-content-center me-2" style="width: 38px; height: 38px; border-radius: 50%; font-size: 1.2rem;">
                                                    <i class="fas fa-chess-pawn"></i>
                                                </div>
                                                <div>
                                                    <span class="fw-bold"><?php echo e($group->name); ?></span>
                                                    <span class="badge bg-info text-white ms-2"><i class="fas fa-user me-1"></i>Anggota UKM</span>
                                                </div>
                                            </div>
                                            <p class="card-text text-muted small">Kode: <?php echo e($group->referral_code); ?></p>
                                            <p class="card-text"><?php echo e(Str::limit($group->description, 100)); ?></p>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="badge bg-info text-white"><i class="fas fa-user me-1"></i>Anggota</span>
                                                <div>
