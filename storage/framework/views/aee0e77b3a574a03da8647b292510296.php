<?php $__env->startSection('title', 'Profil Admin Grup'); ?>
...
<div class="container-fluid p-0">
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="profile-header">
                    <div class="profile-img">
                        <?php if($user->photo): ?>
                            <img src="<?php echo e(asset('storage/' . $user->photo)); ?>" alt="Profile">
                        <?php else: ?>
                            <span class="fallback-initial"><?php echo e(substr($user->name, 0, 1)); ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <form method="POST" action="<?php echo e(route('grup.profile.updatePhoto')); ?>" enctype="multipart/form-data" class="mt-3">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
            ...
            <?php if($user->adminGroups->count() > 0): ?>
                <?php $__currentLoopData = $user->adminGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card admin-info-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <small><i class="fas fa-code me-1"></i> Kode: <?php echo e($group->referral_code); ?></small><br>
                            <small><i class="fas fa-users me-1"></i> Total Anggota: <?php echo e($group->members->count()); ?></small><br>
                            <small><i class="fas fa-calendar me-1"></i> Dibuat: <?php echo e($group->created_at->format('d M Y')); ?></small>
                        </p>
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('grup.dashboard')); ?>" class="btn btn-light btn-sm">
                                <i class="fas fa-tachometer-alt me-1"></i> Dashboard
                            </a>
                            <a href="<?php echo e(route('grup.anggota')); ?>" class="btn btn-light btn-sm">
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('grup.profile.updatePassword')); ?>" class="password-form">
                        <?php echo csrf_field(); ?>
                        <div class="row mb-3">
                            <div class="col-md-4">
...
<?php echo $__env->make('layouts.admin_grup', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MyUkm-main\resources\views/grup/profile.blade.php ENDPATH**/ ?>