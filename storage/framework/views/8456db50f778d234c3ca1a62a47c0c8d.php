...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <?php if(Auth::user()->role === 'admin_grup' && Auth::user()->groups->count() > 0): ?>
            <div class="sidebar-heading border-bottom mt-2 mb-0">
                <i class="fas fa-crown me-1" style="color: #f59e0b;"></i> Admin UKM
            </div>
            <div class="list-group list-group-flush">
                <a href="<?php echo e(route('grup.dashboard')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('grup.dashboard') ? 'active' : ''); ?>">
                    <i class="fas fa-tachometer-alt"></i> Dashboard
                </a>
                <a href="<?php echo e(route('grup.anggota')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('grup.anggota') ? 'active' : ''); ?>">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        ...
                        <?php if(Auth::user()->role === 'admin_grup' && Auth::user()->groups && Auth::user()->groups->count() > 0): ?>
                            <li><hr class="dropdown-divider"></li>
                            <li class="dropdown-header"><i class="fas fa-crown me-2" style="color: #f59e0b;"></i>Menu Admin UKM</li>
                            <?php $__currentLoopData = Auth::user()->groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('grup.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i>Dashboard <?php echo e($group->name); ?></a></li>
