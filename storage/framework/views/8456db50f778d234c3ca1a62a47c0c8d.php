    ...
    <div class="sidebar" id="sidebar">
        ...
        <?php if(Auth::user()->role === 'admin_grup'): ?>
            ...
            <?php if($managedGroups->count() > 0): ?>
                ...
                <div class="list-group list-group-flush">
                    <a href="<?php echo e(route('grup.dashboard')); ?>" class="list-group-item list-group-item-action admin-menu-item <?php echo e(request()->routeIs('grup.dashboard') ? 'active' : ''); ?>">
                        <i class="fas fa-tachometer-alt"></i> Dashboard Admin
                    </a>
            <a href="<?php echo e(route('grup.anggota')); ?>" class="list-group-item list-group-item-action admin-menu-item <?php echo e(request()->routeIs('grup.anggota') ? 'active' : ''); ?>">
                <i class="fas fa-users-cog"></i> Kelola Anggota
            </a>
            <a href="<?php echo e(route('grup.riwayat_anggota')); ?>" class="list-group-item list-group-item-action admin-menu-item <?php echo e(request()->routeIs('grup.riwayat_anggota') ? 'active' : ''); ?>">
                <i class="fas fa-history"></i> Riwayat Anggota Keluar
            </a>
                    <?php $__currentLoopData = $managedGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('ukm.chat', $group->referral_code)); ?>" class="list-group-item list-group-item-action admin-menu-item <?php echo e(request()->is('ukm/'.$group->referral_code.'/chat') ? 'active' : ''); ?>">
                            <i class="fas fa-comments"></i> Chat <?php echo e($group->name); ?>
        ...
        ?>
        <?php if($regularGroups->count() > 0): ?>
            <div class="sidebar-heading border-bottom mt-2 mb-0">
                UKM Saya
            </div>
            <?php $__currentLoopData = $regularGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="avatar">
                            <?php if(Auth::user()->photo_url): ?>
                                <img src="<?php echo e(Auth::user()->photo_url); ?>" alt="Foto Profil" style="display:block;margin:auto;width:100%;height:100%;object-fit:cover;border-radius:50%;border:2px solid #fff;box-shadow:0 0 0 2px #4338ca;">
                            <?php elseif(Auth::user()->role === 'admin_grup'): ?>
                                <i class="fas fa-crown" style="color: #f59e0b;display:flex;align-items:center;justify-content:center;width:100%;height:100%;"></i>
                            <?php else: ?>
                                <i class="fas fa-chess-pawn" style="color: #2563eb;display:flex;align-items:center;justify-content:center;width:100%;height:100%;"></i>
                            <?php endif; ?>
                        </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        ...
                        <?php if(Auth::user()->role === 'admin_grup'): ?>
                            ...
                            <?php if($managedGroups->count() > 0): ?>
                                ...
                                <li><a class="dropdown-item" href="<?php echo e(route('grup.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i>Dashboard Admin</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('grup.anggota')); ?>"><i class="fas fa-users-cog me-2"></i>Kelola Anggota</a></li>
                                <?php $__currentLoopData = $managedGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a class="dropdown-item" href="<?php echo e(route('ukm.chat', $group->referral_code)); ?>"><i class="fas fa-comments me-2"></i>Chat <?php echo e($group->name); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        <?php endif; ?>
                        <li><hr class="dropdown-divider"></li>
