                    ...
                    <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="avatar">
                            <?php if(Auth::user()->photo_url): ?>
                                <img src="<?php echo e(Auth::user()->photo_url); ?>" alt="Foto Profil" style="width:100%;height:100%;object-fit:cover;border-radius:50%;border:2px solid #fff;box-shadow:0 0 0 2px #4338ca;">
                            <?php elseif(Auth::user()->role === 'admin_grup'): ?>
                                <i class="fas fa-crown" style="color: #f59e0b;"></i>
                            <?php else: ?>
                                <i class="fas fa-chess-pawn" style="color: #2563eb;"></i>
                            <?php endif; ?>
                        </div>
                        <span class="d-none d-sm-inline">
                            ...
                            <?php if(Auth::user()->role === 'admin_grup'): ?>
                                <span class="admin-badge ms-2"><i class="fas fa-crown me-1"></i>Admin UKM</span>
                            <?php else: ?>
                                <span class="badge bg-primary ms-2"><i class="fas fa-chess-pawn me-1"></i>Anggota UKM</span>
                            <?php endif; ?>
                        </span>
                    </a>
...
<?php /**PATH C:\xampp\htdocs\MyUkm-master\resources\views/layouts/user.blade.php ENDPATH**/ ?>