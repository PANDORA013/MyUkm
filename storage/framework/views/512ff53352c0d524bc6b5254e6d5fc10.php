                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold"><?php echo e($anggota->where('role', 'admin_grup')->count()); ?></div>
                        ...
                        <form method="GET" class="d-flex">
                            <div class="input-group input-group-sm">
                                ...
                                <?php if(request('search')): ?>
                                    <a href="<?php echo e(route('admin.ukm.anggota', $ukm->id)); ?>" class="btn btn-outline-danger">
                                    ...
                                    <?php $__currentLoopData = $anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <span class="badge bg-<?php echo e($roleData[1]); ?>"><?php echo e($roleData[0]); ?></span>
                                            </td>
                                            <td>
                                                <?php
                                                    ...
                                                    <?php if(auth()->user()->role === 'admin_website' && $user->role !== 'admin_website'): ?>
                                                        <?php if($user->role !== 'admin_grup'): ?>
                                                            <button type="button" 
                                                                    ...
                                                                    onclick="confirmMakeAdmin(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>')">
                                                        ...
                                                        <?php else: ?>
                                                            <button type="button" 
                                                                    ...
                                                                    onclick="confirmRemoveAdmin(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>')">
