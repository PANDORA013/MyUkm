...
<div class="min-h-screen bg-gray-100">
    <div class="max-w-4xl mx-auto py-6">
        ...
        <div class="bg-white rounded-lg shadow" 
             ...
             data-group-id="<?php echo e($groupId); ?>"
             data-typing-timeout="<?php echo e($typingTimeout); ?>">
            <!-- Header -->
            <div class="border-b p-4 flex justify-between items-center">
                <div>
                    <h1 class="text-xl font-semibold"><?php echo e($groupName); ?></h1>
                    <p class="text-sm text-gray-600">
                        <span id="online-count"><?php echo e($memberCount); ?></span> Anggota
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="<?php echo e(route('ukm.index')); ?>" class="text-blue-600 hover:text-blue-800">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div id="chat-messages" class="h-[500px] overflow-y-auto p-4 space-y-3">
                <?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex <?php echo e($chat->user_id === auth()->id() ? 'justify-end' : 'justify-start'); ?>"
                         data-message-id="<?php echo e($chat->id); ?>">
                        <div class="max-w-[80%]">
                            <div class="flex items-center gap-2 <?php echo e($chat->user_id === auth()->id() ? 'justify-end' : 'justify-start'); ?>">
                                <span class="text-sm text-gray-600"><?php echo e($chat->user->name); ?></span>
                                <?php if($chat->user_id === auth()->id()): ?>
                                    <span class="read-status text-xs text-gray-400">
                                        <?php echo e($chat->read_at ? '✓✓' : '✓'); ?>

                                    </span>
                                <?php endif; ?>
                            </div>
                            <div class="<?php echo e($chat->user_id === auth()->id() ? 'bg-blue-500 text-white' : 'bg-gray-100'); ?> rounded-lg px-3 py-2">
                                <?php echo $chat->message; ?>

                            </div>
                            <div class="text-xs text-gray-500 mt-1"><?php echo e($chat->created_at->format('H:i')); ?></div>
                        </div>
                    </div>
    ...
    messageForm.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch('/chat/send', {
                ...
                body: JSON.stringify({
                    message,
                    group_code: '<?php echo e($groupCode); ?>'
                })
            });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MyUkm-main\resources\views\chat\index.blade.php ENDPATH**/ ?>