...
<div class="container-fluid p-0">
        ...
        <?php if($managed_groups->count() > 1): ?>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="groupSelector">
                    <?php $__currentLoopData = $managed_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $managedGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a class="dropdown-item <?php echo e($group && $group->id === $managedGroup->id ? 'active' : ''); ?>" 
                               href="<?php echo e(route('grup.anggota', ['group_id' => $managedGroup->id])); ?>">
    ...
    <?php else: ?>
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1">
                                                <div class="d-flex justify-content-between align-items-start mb-2">
                                                    <div>
                                                        <h6 class="mb-1 fw-bold"><?php echo e($member->name); ?>

                                                            <?php if($member->role === 'admin_grup'): ?>
                                                                <span class="badge bg-warning text-white ms-2"><i class="fas fa-crown me-1"></i>Admin UKM</span>
                                                            <?php else: ?>
                                                                <span class="badge bg-info text-white ms-2"><i class="fas fa-user me-1"></i>Anggota</span>
                                                            <?php endif; ?>
                                                        </h6>
        ...
        <!-- Ex-Members List (History) fully removed for cleaner Kelola Anggota page -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="btn btn-outline-secondary" onclick="copyToClipboard('<?php echo e($group->referral_code); ?>')" aria-label="Salin kode referral" title="Salin kode referral ke clipboard">
