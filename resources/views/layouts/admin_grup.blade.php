...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        @if(Auth::user()->role === 'admin_grup')
            ...
            <a href="{{ route('grup.riwayat_anggota') }}" class="list-group-item list-group-item-action admin-menu-item {{ request()->routeIs('grup.riwayat_anggota') ? 'active' : '' }}">
                    ...
                    <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="avatar">
                            @if(Auth::user()->photo_url)
                                <img src="{{ Auth::user()->photo_url }}" alt="Foto Profil" style="display:block;margin:auto;width:100%;height:100%;object-fit:cover;border-radius:50%;border:2px solid #fff;box-shadow:0 0 0 2px #4338ca;">
                            @elseif(Auth::user()->role === 'admin_grup')
