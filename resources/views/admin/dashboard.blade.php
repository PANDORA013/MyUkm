...
@section('content')
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="{{ route('admin.members') }}" style="text-decoration: none;">
        ...
        <!-- Total UKM -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="{{ route('admin.ukms') }}" style="text-decoration: none;">
        ...
        <!-- Riwayat Penghapusan -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="{{ route('admin.user-deletions.index') }}" style="text-decoration: none;">
        ...
        <!-- Admin Grup -->
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="{{ route('admin.users.admins') }}" style="text-decoration: none;">
    ...
    <div class="row mb-4">
        ...
        <!-- Pengguna Baru -->
        <div class="col-xl-4 col-md-6 mb-4">
            <a href="{{ route('admin.users.new') }}" style="text-decoration: none;">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <a href="{{ route('admin.ukms.average') }}" style="text-decoration: none;">
