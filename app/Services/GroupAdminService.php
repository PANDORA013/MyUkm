...
/**
 * Service class for group admin operations
 * 
 * Handles business logic for admin group management functionality
 * including dashboard stats, member management, and group operations.
 */
